...
![](/images/posts/password-management/sops-physical-key-prompt.jpg)
...
$ pass git remote add origin https://github.com/moeleak/password-store
$ pass git push
```
...
$ gpg --edit-key <KEY_ID>
$ trust
$ pass git clone https://github.com/moeleak/password-store
$ pass GitHub/moeleak
```
